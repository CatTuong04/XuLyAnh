...
def de_motion_page():
    st.title("Khôi Phục Ảnh Nhòe Chuyển Động (De-Motion)")
    ...
    if uploaded_file is not None:
        try:
            ...
            with st.spinner("Applying de-motion filter..."):
                img_filtered = c5.DeMotion(img_gray)
            ...
            with col2:
                st.image(result_pil, caption="Ảnh sau khi khôi phục nhòe chuyển động", use_container_width=True)
